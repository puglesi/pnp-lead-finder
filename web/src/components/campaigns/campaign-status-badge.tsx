...
> = {
  ...
  saved: {
    label: "Salva",
    className: "border-sky-500/40 bg-sky-500/15 text-sky-800 dark:text-sky-300",
  },
  active: {
    label: "Em andamento",
  ...
  paused: {
    label: "Pausada",
    className: "border-amber-500/40 bg-amber-500/15 text-amber-900 dark:text-amber-300",
  },
  completed: {
    label: "Concluída",
  ...
  archived: {
    label: "Arquivada",
    className: "border-zinc-500/40 bg-zinc-500/15 text-zinc-800 dark:text-zinc-300",
  },
};
